export const translations = {
    ar: {
        ...
        hero: {
            badge: "معدات احترافية عالية الأداء",
            title: "طقم مضاد للمطر",
            subtitle: "سترة وسروال للمطر — حماية كاملة ورؤية عالية"
        },
        pricing: {
            save: "وفر 33%",
            original: "4,500 دج",
        ...
        specs: {
            ...
            structure: { label: "الهيكل", value: "بوليستر عالي الكثافة" },
            visibility: { label: "الرؤية", value: "أشرطة عاكسة" },
            waterproof: { label: "مقاومة الماء", value: "غشاء مسامي" },
            care: { label: "العناية", value: "غسيل آلي 30 درجة" }
        },
        features: {
            shipping: { title: "توصيل لـ 58 ولاية", text: "توصيل سريع للمنزل أو المكتب." },
        ...
        editorial: {
            ...
            point2: "تعدد الاستخدامات: عمل (بناء، لوجستيات) وترفيه",
        ...
        footer: {
            rights: "© 2026 الجزائر — جميع الحقوق محفوظة"
        },
        form: {
            title: "تأكيد الطلب",
    ...
    fr: {
        ...
        hero: {
            badge: "Équipement Professionnel Haute Performance",
            title: "ENSEMBLE IMPERMÉABLE",
            subtitle: "Veste et Pantalon de Pluie — Protection Intégrale & Haute Visibilité"
        },
        pricing: {
            save: "Save 33%",
            original: "4,500 DZD",
        ...
        specs: {
            ...
            structure: { label: "Structure", value: "Polyester Haute Densité" },
            visibility: { label: "Visibilité", value: "Bandes Réfléchissantes" },
            waterproof: { label: "Étanchéité", value: "Membrane Hydrophobe" },
            care: { label: "Entretien", value: "Lavage Machine 30°C" }
        },
        features: {
            shipping: { title: "Expédition 58 Wilayas", text: "Livraison rapide à domicile ou au bureau." },
        ...
        editorial: {
            ...
            point2: "Polyvalence : Travail (BTP, Logistique) & Loisirs",
        ...
        footer: {
            rights: "© 2026 Algérie — Tous droits réservés"
        },
        form: {
